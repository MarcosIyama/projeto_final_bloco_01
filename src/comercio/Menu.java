...
public class Menu {
	...
	public static void main(String[] args) {
		...
		ProdutoCamiseta pcm1 = new ProdutoCamiseta(2, "Camiseta maneira", "Branca", 38, produtos.gerarNumero(), 29.99f,
				1);
		produtos.adicionarProduto(pcm1);

		ProdutoCamiseta pcm2 = new ProdutoCamiseta(2, "Camiseta confortável", "Verde", 50, produtos.gerarNumero(),
				13.99f, 3);
			...
			case 1:
				...
				case 1 -> {
					...
					produtos.adicionarProduto(
							new ProdutoCalcado(tipo, nome, cor, numeracao, produtos.gerarNumero(), valor, cadarco));
				}
				case 2 -> {
					System.out.println("-----------------------");
					...
					manga = leia.nextInt();
					produtos.adicionarProduto(
							new ProdutoCamiseta(tipo, nome, cor, numeracao, produtos.gerarNumero(), valor, manga));
				}
				}
